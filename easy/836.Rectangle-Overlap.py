...
assert isRectangleOverlap(rec1=[0, 0, 2, 2], rec2=[1, 1, 3, 3])
assert not isRectangleOverlap(rec1=[0, 0, 1, 1], rec2=[1, 0, 2, 1])
assert not isRectangleOverlap(rec1=[0, 0, 1, 1], rec2=[2, 2, 3, 3])

...
labeled from 1 to n. A marathon will be held on this track, the marathon consists of m rounds.
The ith round starts at sector rounds[i - 1] and ends at sector rounds[i]. For example, round 1
...
assert mostVisited(4, [1, 3, 1, 2]) == [1, 2]
assert mostVisited(2, [2, 1, 2, 1, 2, 1, 2, 1, 2]) == [2]
assert mostVisited(7, [1, 3, 5, 7]) == [1, 2, 3, 4, 5, 6, 7]

...
Hint 2
Loop over all character from 'a' to 'z' and append the character if it exists and decrease frequency by 1.
...
def sortString(s: str) -> str:
    ...
    while count:
        for chars in ascii_lowercase, reversed(ascii_lowercase):
            result += [c for c in chars if c in count]

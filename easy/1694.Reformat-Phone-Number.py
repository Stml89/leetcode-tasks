...
the digits from left to right into blocks of length 3 until there are 4 or fewer digits. The final digits are then grouped as follows:
...
def reformatNumber(number: str) -> str:
    ...
    while i < n:
        if n - i > 4:
            ...
            res.append(number[i:n])
            break

    return "-".join(res)


assert reformatNumber("1-23-45 6") == "123-45-67"

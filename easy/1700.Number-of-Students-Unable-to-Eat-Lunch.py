...
You are given two integer arrays students and sandwiches where sandwiches[i] is the type of the i
sandwich in the stack (i = 0 is the top of the stack) and students[j] is the preference of the j

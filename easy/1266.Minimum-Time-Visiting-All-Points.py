...
From [3,2] to [2,2] it takes 1 second (1 horizontal to [2,2]).
From [2,2] to [1,2] it takes 1 second (1 horizontal to [1,2]).
From [1,2] to [0,2] it takes 1 second (1 horizontal to [0,2]).
From [0,2] to [-1,2] it takes 1 second (1 horizontal to [-1,2]).
From [-1,2] to [-2,2] it takes 1 second (1 horizontal to [-2,2]).
